...
public class CurteaVeche extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CurteaVeche frame = new CurteaVeche();
	...
	public CurteaVeche() {
		...
		String [] column4= {"1","La Lilieci","Marin Sorescu","Curtea Veche", "28"};
		model.addRow(column4);
		
		String [] column1= {"2","Sarmanul Dionis","Mihai Eminescu","Curtea Veche", "25"};
		model.addRow(column1);
		
		String [] column2= {"3","Geniu Pustiu","Mihai Eminescu","Curtea Veche", "27"};
		model.addRow(column2);
		
		String [] column5= {"4","O scrisoare pierduta","Ion Luca Caragiale","Curtea Veche", "28"};
		model.addRow(column5);
		
		String [] column12= {"5","Napasta","Ion luca Cragiale","Curtea Veche", "27"};
		model.addRow(column12);
