...
public class Corint extends JFrame {
	...
	public Corint() {
		...
		String [] column3= {"1","Postum","Mihai Eminescu","Corint", "25"};
		model.addRow(column3);
		
		String [] column4= {"2","Trei dinti din fata","Marin Sorescu","Corint", "29"};
		model.addRow(column4);
		
		String [] column5= {"3","O noapte furtunoasa","Ion Luca Caragiale","Corint", "21"};
