...
public class CarteaRomaneasca extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CarteaRomaneasca frame = new CarteaRomaneasca();
	...
	public CarteaRomaneasca() {
		...
		String [] column4= {"1","Mara","Ioan Slavici","Cartea Romaneasca", "28"};
		model.addRow(column4);
		
		String [] column5= {"2","Moara cu noroc","Ioan Slavici","Cartea Romaneasca", "18"};
		model.addRow(column5);
		
		String [] column1= {"3","Poesii","Mihai Eminescu","Cartea Romaneasca", "33"};
		model.addRow(column1);
		
		String [] column2= {"4","Periodice","Mihai Eminescu","Cartea Romaneasca", "35"};
		model.addRow(column2);
		
		String [] column3= {"5","Singur pintre poeti","Marin Sorescu","Cartea Romaneasca", "18"};
		model.addRow(column3);
		
		String [] column7= {"6","Basme","Ion Creanga","Cartea Romaneasca", "25"};
		
		String [] column13= {"7","Iona","Marin Sorescu","Cartea Romaneasca", "30"};
		model.addRow(column13);
		
		String [] column14= {"8","Matca","Marin Sorescu","Cartea Romaneasca", "28"};
		model.addRow(column14);
