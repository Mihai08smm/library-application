...
public class MarinSorescu extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MarinSorescu frame = new MarinSorescu();
	...
	public MarinSorescu() {
		...
		String [] column3= {"2","Trei dinti din fata","Marin Sorescu","Corint", "29"};
		model.addRow(column3);
		
		String [] column1= {"3","Iona","Marin Sorescu","Cartea Romaneasca", "30"};
		model.addRow(column1);
		
		String [] column2= {"4","Matca","Marin Sorescu","Cartea Romaneasca", "28"};
