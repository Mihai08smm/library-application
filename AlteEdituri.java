...
public class AlteEdituri extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlteEdituri frame = new AlteEdituri();
	...
	public AlteEdituri() {
		...
		String [] column6= {"1","Poezii","Ion Barbu","Haiducul", "30"};
		model.addRow(column6);
		
		String [] column8= {"2","Basme","Petre Ispirescu","Doispe", "25.99"};
		model.addRow(column8);
		
		String [] column61= {"3","Profu'"," Boris Ioan","Vrede", "54"};
		model.addRow(column61);
